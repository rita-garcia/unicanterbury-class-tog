...
.. youtube:: CrydSpPplUQ
    :divid: intro-timed-exam-v1-class-tog
    :optional:
    :width: 650
    :align: center
...
.. timed:: timed_intro-class-tog
   :timelimit: 5
   :noresult:
   :nofeedback:
   :nopause:

   .. mchoice:: timed_intro_q1_add-class-tog
      :practice: T
      :answer_a: 3
      :answer_b: 4
      :answer_c: 7
   ...
   .. mchoice:: timed_intro_q2_str_upper-class-tog
      :practice: T
      :answer_a: hi there
      :answer_b: Hi There
      :answer_c: HI there
...
.. shortanswer:: class-tog-pre-timed-intro-sa
