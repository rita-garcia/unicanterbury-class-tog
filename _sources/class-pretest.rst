...
.. timed:: timed1
   ...
   .. selectquestion:: class-tog-pre-1
      :fromid: pretest_cond_with_funcs
      :points: 1

   .. selectquestion:: class-tog-pre-2
   ...
   .. selectquestion:: class-tog-pre-5
      :fromid: pretest_sum_with_range
      :points: 1

   .. selectquestion:: class-tog-pre-6
      :fromid: pretest_string_abbrev
      :points: 1

   .. selectquestion:: class-tog-pre-7
      :fromid: pretest_sum_with_mod
      :points: 1

   .. selectquestion:: class-tog-pre-8
      :fromid: pretest-while-str-concat
      :points: 1

   .. selectquestion:: class-tog-pre-9
      :fromid: pretest-break-cont-str-cont
      :points: 1

   .. selectquestion:: class-tog-pre-10
